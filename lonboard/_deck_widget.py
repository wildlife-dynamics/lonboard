...
class ZoomWidget(BaseDeckWidget):
    ...
    zoom_in_label = traitlets.Unicode(default_value=None, allow_none=True).tag(
        sync=True,
    )
    zoom_out_label = traitlets.Unicode(default_value=None, allow_none=True).tag(
        sync=True,
    )
    transition_duration = traitlets.Int(default_value=None, allow_none=True).tag(
        sync=True,
    )
    class_name = traitlets.Unicode(default_value=None, allow_none=True).tag(sync=True)
